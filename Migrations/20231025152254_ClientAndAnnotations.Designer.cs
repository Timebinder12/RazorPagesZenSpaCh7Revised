...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231025152254_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 25, 11, 22, 54, 424, DateTimeKind.Local).AddTicks(1718),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 25, 11, 22, 54, 424, DateTimeKind.Local).AddTicks(1762),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 25, 11, 22, 54, 424, DateTimeKind.Local).AddTicks(1764),
                            ServicesID = 5
                        });
                });
